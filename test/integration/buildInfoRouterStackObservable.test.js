/**
 * Tests for GitHub issue #345 (refactored per issues #382, #385):
 *
 ...
 *
 * Issue #385: removed guard-reset tests that directly manipulated
 * app.locals._buildInfoRegistered, coupling tests to an implementation
 * detail. The double-registration tests already cover idempotency via
 * observable HTTP behavior without internal coupling.
 */
